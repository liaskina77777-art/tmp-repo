...
18 из 23 белков (78%) содержат Pfam-аннотированные домены, обнаружено 30 Pfam доменов (у некоторых белков по несколько доменов)
...
3. GET /health (дополнительный) - Для проверки состояния сервера
